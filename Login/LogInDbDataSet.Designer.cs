...
namespace Login.LogInDbDataSetTableAdapters {
    ...
    public partial class AspNetUsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[AspNetUsers] WHERE (([Id] = @Original_Id) AND ([Email] = @Original_Email) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_NormalizedUserName = 1 AND [NormalizedUserName] IS NULL) OR ([NormalizedUserName] = @Original_NormalizedUserName)) AND ((@IsNull_NormalizedEmail = 1 AND [NormalizedEmail] IS NULL) OR ([NormalizedEmail] = @Original_NormalizedEmail)) AND ([EmailConfirmed] = @Original_EmailConfirmed) AND ([PhoneNumberConfirmed] = @Original_PhoneNumberConfirmed) AND ([TwoFactorEnabled] = @Original_TwoFactorEnabled) AND ((@IsNull_LockoutEnd = 1 AND [LockoutEnd] IS NULL) OR ([LockoutEnd] = @Original_LockoutEnd)) AND ([LockoutEnabled] = @Original_LockoutEnabled) AND ([AccessFailedCount] = @Original_AccessFailedCount))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[AspNetUsers] ([Id], [Name], [Email], [Address], [UserName], [NormalizedUserName], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) VALUES (@Id, @Name, @Email, @Address, @UserName, @NormalizedUserName, @NormalizedEmail, @EmailConfirmed, @PasswordHash, @SecurityStamp, @ConcurrencyStamp, @PhoneNumber, @PhoneNumberConfirmed, @TwoFactorEnabled, @LockoutEnd, @LockoutEnabled, @AccessFailedCount);
SELECT Id, Name, Email, Address, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount FROM AspNetUsers WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[AspNetUsers] SET [Id] = @Id, [Name] = @Name, [Email] = @Email, [Add" +
                "ress] = @Address, [UserName] = @UserName, [NormalizedUserName] = @NormalizedUser" +
                "Name, [NormalizedEmail] = @NormalizedEmail, [EmailConfirmed] = @EmailConfirmed, " +
                "[PasswordHash] = @PasswordHash, [SecurityStamp] = @SecurityStamp, [ConcurrencySt" +
                "amp] = @ConcurrencyStamp, [PhoneNumber] = @PhoneNumber, [PhoneNumberConfirmed] =" +
                " @PhoneNumberConfirmed, [TwoFactorEnabled] = @TwoFactorEnabled, [LockoutEnd] = @" +
                "LockoutEnd, [LockoutEnabled] = @LockoutEnabled, [AccessFailedCount] = @AccessFai" +
                "ledCount WHERE (([Id] = @Original_Id) AND ([Email] = @Original_Email) AND ((@IsN" +
                "ull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) A" +
                "ND ((@IsNull_NormalizedUserName = 1 AND [NormalizedUserName] IS NULL) OR ([Norma" +
                "lizedUserName] = @Original_NormalizedUserName)) AND ((@IsNull_NormalizedEmail = " +
                "1 AND [NormalizedEmail] IS NULL) OR ([NormalizedEmail] = @Original_NormalizedEma" +
                "il)) AND ([EmailConfirmed] = @Original_EmailConfirmed) AND ([PhoneNumberConfirme" +
                "d] = @Original_PhoneNumberConfirmed) AND ([TwoFactorEnabled] = @Original_TwoFact" +
                "orEnabled) AND ((@IsNull_LockoutEnd = 1 AND [LockoutEnd] IS NULL) OR ([LockoutEn" +
                "d] = @Original_LockoutEnd)) AND ([LockoutEnabled] = @Original_LockoutEnabled) AN" +
                "D ([AccessFailedCount] = @Original_AccessFailedCount));\r\nSELECT Id, Name, Email," +
                " Address, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, Passwor" +
                "dHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFa" +
                "ctorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount FROM AspNetUsers WHER" +
                "E (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=PEJUS;Initial Catalog=LogInDb;User ID=sa;Password=12345;TrustServerCe" +
                "rtificate=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT Id, Name, Email, Address, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount FROM dbo.AspNetUsers";
        ...
        public virtual int Fill(LogInDbDataSet.AspNetUsersDataTable dataTable) {
        ...
        public virtual LogInDbDataSet.AspNetUsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LogInDbDataSet.AspNetUsersDataTable dataTable = new LogInDbDataSet.AspNetUsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LogInDbDataSet.AspNetUsersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Id, string Original_Email, string Original_UserName, string Original_NormalizedUserName, string Original_NormalizedEmail, bool Original_EmailConfirmed, bool Original_PhoneNumberConfirmed, bool Original_TwoFactorEnabled, global::System.Nullable<global::System.DateTimeOffset> Original_LockoutEnd, bool Original_LockoutEnabled, int Original_AccessFailedCount) {
            ...
            if ((Original_NormalizedUserName == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_NormalizedUserName));
            }
            if ((Original_NormalizedEmail == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_NormalizedEmail));
            }
            this.Adapter.DeleteCommand.Parameters[8].Value = ((bool)(Original_EmailConfirmed));
            this.Adapter.DeleteCommand.Parameters[9].Value = ((bool)(Original_PhoneNumberConfirmed));
            this.Adapter.DeleteCommand.Parameters[10].Value = ((bool)(Original_TwoFactorEnabled));
            if ((Original_LockoutEnd.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[11].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[12].Value = ((System.DateTimeOffset)(Original_LockoutEnd.Value));
            }
            else {
                this.Adapter.DeleteCommand.Parameters[11].Value = ((object)(1));
                this.Adapter.DeleteCommand.Parameters[12].Value = global::System.DBNull.Value;
            }
            this.Adapter.DeleteCommand.Parameters[13].Value = ((bool)(Original_LockoutEnabled));
            this.Adapter.DeleteCommand.Parameters[14].Value = ((int)(Original_AccessFailedCount));
        ...
        public virtual int Insert(
            ...
            if ((NormalizedUserName == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(NormalizedUserName));
            }
            if ((NormalizedEmail == null)) {
                this.Adapter.InsertCommand.Parameters[6].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[6].Value = ((string)(NormalizedEmail));
            }
            ...
            if ((ConcurrencyStamp == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[10].Value = ((string)(ConcurrencyStamp));
            }
            if ((PhoneNumber == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[12].Value = ((bool)(PhoneNumberConfirmed));
            this.Adapter.InsertCommand.Parameters[13].Value = ((bool)(TwoFactorEnabled));
            if ((LockoutEnd.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[14].Value = ((System.DateTimeOffset)(LockoutEnd.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[14].Value = global::System.DBNull.Value;
            }
            this.Adapter.InsertCommand.Parameters[15].Value = ((bool)(LockoutEnabled));
            this.Adapter.InsertCommand.Parameters[16].Value = ((int)(AccessFailedCount));
        ...
        public virtual int Update(
            ...
            if ((NormalizedUserName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(NormalizedUserName));
            }
            if ((NormalizedEmail == null)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(NormalizedEmail));
            }
            ...
            if ((ConcurrencyStamp == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(ConcurrencyStamp));
            }
            if ((PhoneNumber == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((bool)(PhoneNumberConfirmed));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((bool)(TwoFactorEnabled));
            if ((LockoutEnd.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((System.DateTimeOffset)(LockoutEnd.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[15].Value = ((bool)(LockoutEnabled));
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(AccessFailedCount));
            if ((Original_Id == null)) {
                throw new global::System.ArgumentNullException("Original_Id");
            }
            else {
            ...
            if ((Original_NormalizedUserName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_NormalizedUserName));
            }
            if ((Original_NormalizedEmail == null)) {
        ...
        public virtual int Update(
                    ...
                    bool Original_LockoutEnabled, 
                    int Original_AccessFailedCount) {
            return this.Update(Original_Id, Name, Email, Address, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount, Original_Id, Original_Email, Original_UserName, Original_NormalizedUserName, Original_NormalizedEmail, Original_EmailConfirmed, Original_PhoneNumberConfirmed, Original_TwoFactorEnabled, Original_LockoutEnd, Original_LockoutEnabled, Original_AccessFailedCount);
        }
    }
