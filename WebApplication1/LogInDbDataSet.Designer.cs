...
namespace WebApplication1.LogInDbDataSetTableAdapters {
    ...
    public partial class AspNetUsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[AspNetUsers] SET [Id] = @Id, [Name] = @Name, [Email] = @Email, [Address] = @Address, [UserName] = @UserName, [NormalizedUserName] = @NormalizedUserName, [NormalizedEmail] = @NormalizedEmail, [EmailConfirmed] = @EmailConfirmed, [PasswordHash] = @PasswordHash, [SecurityStamp] = @SecurityStamp, [ConcurrencyStamp] = @ConcurrencyStamp, [PhoneNumber] = @PhoneNumber, [PhoneNumberConfirmed] = @PhoneNumberConfirmed, [TwoFactorEnabled] = @TwoFactorEnabled, [LockoutEnd] = @LockoutEnd, [LockoutEnabled] = @LockoutEnabled, [AccessFailedCount] = @AccessFailedCount WHERE (([Id] = @Original_Id))";
        ...
        public virtual int Update(
                    ...
                    int AccessFailedCount, 
                    string Original_Id) {
            return this.Update(Original_Id, Name, Email, Address, UserName, NormalizedUserName, NormalizedEmail, EmailConfirmed, PasswordHash, SecurityStamp, ConcurrencyStamp, PhoneNumber, PhoneNumberConfirmed, TwoFactorEnabled, LockoutEnd, LockoutEnabled, AccessFailedCount, Original_Id);
        }
    }
